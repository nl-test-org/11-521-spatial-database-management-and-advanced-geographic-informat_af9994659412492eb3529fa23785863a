...
menu:
  leftnav:
    identifier: 33df897f4639c5d6758749e09fa048b1
    name: Projects
    weight: 80
title: Projects
type: course
uid: 33df897f4639c5d6758749e09fa048b1

---

Please note: all associated databases for the course are in the [tools]({{< baseurl >}}/sections/tools) section.
...
(**data layer list**) ([PDF]({{< baseurl >}}/sections/projects/data_list_v2))
...
*   **Baltimore** ([PDF]({{< baseurl >}}/sections/projects/webtest_baltimore))
*   **Los Angeles** ([PDF]({{< baseurl >}}/sections/projects/webtest_los_angeles))
*   **Oakland** ([PDF]({{< baseurl >}}/sections/projects/webtest_oakland))
*   **Philadelphia** ([PDF]({{< baseurl >}}/sections/projects/webtest_philadelph_2))
*   **Providence** ([PDF]({{< baseurl >}}/sections/projects/webtest_providence))
...
*   Map of the Reviviendo Gateway Overlay (RGO) District ([PDF]({{< baseurl >}}/sections/projects/zoningmap))
*   Submitted Zoning Description ([PDF]({{< baseurl >}}/sections/projects/submitt_zoning_31803))
*   Zoning Analysis ([PDF]({{< baseurl >}}/sections/projects/zoning_extract))
*   Zoning Overlay District Overview ([PDF]({{< baseurl >}}/sections/projects/zonin_overl_dis_over))
*   Zoning Process and Timeline ([PDF]({{< baseurl >}}/sections/projects/zoning_process_timel))
*   Question and Answers about RGO ([PDF]({{< baseurl >}}/sections/projects/zoning_qa))
